...
class Google_Service_Vision_Resource_Files extends Google_Service_Resource
{
   ...
   *
   * @param Google_Service_Vision_GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Vision_Operation
   */
  public function asyncBatchAnnotate(Google_Service_Vision_GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest $postBody, $optParams = array())
  {
