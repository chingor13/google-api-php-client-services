...
class Google_Service_CloudVideoIntelligence_Resource_Videos extends Google_Service_Resource
{
   ...
   *
   * @param Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudVideoIntelligence_GoogleLongrunningOperation
   */
  public function annotate(Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest $postBody, $optParams = array())
  {
