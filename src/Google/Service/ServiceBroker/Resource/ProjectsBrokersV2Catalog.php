...
class Google_Service_ServiceBroker_Resource_ProjectsBrokersV2Catalog extends Google_Service_Resource
{
   ...
   * @return Google_Service_ServiceBroker_GoogleCloudServicebrokerV1alpha1ListCatalogResponse
   */
  public function listProjectsBrokersV2Catalog($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_ServiceBroker_GoogleCloudServicebrokerV1alpha1ListCatalogResponse");
  }
}
