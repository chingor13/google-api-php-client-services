 ...
 *   $v1alpha1 = $servicebrokerService->v1alpha1;
 *  </code>
 */
class Google_Service_ServiceBroker_Resource_V1alpha1 extends Google_Service_Resource
{
  /**
   * Gets the access control policy for a resource. Returns an empty policy if the
   * resource exists and does not have a policy set. (v1alpha1.getIamPolicy)
   *
   ...
   * existing policy. (v1alpha1.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * "fail open" without warning. (v1alpha1.testIamPermissions)
   *
