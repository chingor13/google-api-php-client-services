 ...
 *   $v1beta1 = $servicebrokerService->v1beta1;
 *  </code>
 */
class Google_Service_ServiceBroker_Resource_V1beta1 extends Google_Service_Resource
{
  /**
   * Gets the access control policy for a resource. Returns an empty policy if the
   * resource exists and does not have a policy set. (v1beta1.getIamPolicy)
   *
   ...
   * existing policy. (v1beta1.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * "fail open" without warning. (v1beta1.testIamPermissions)
   *
