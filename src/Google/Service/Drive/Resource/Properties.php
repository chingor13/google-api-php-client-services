 ...
 *  </code>
 */
class Google_Service_Drive_Resource_Properties extends Google_Service_Resource
{
  /**
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string visibility The visibility of the property. Allowed values
   * are PRIVATE and PUBLIC. (Default: PRIVATE)
   * @return Google_Service_Drive_Property
   */
