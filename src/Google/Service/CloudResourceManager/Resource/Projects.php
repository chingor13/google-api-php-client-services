...
class Google_Service_CloudResourceManager_Resource_Projects extends Google_Service_Resource
{
   ...
   * include both an ID and a type, such as organization.
   *
   ...
   * Subtrees of Resource Manager resource hierarchy with 'under:' prefix will not
   * be expanded. (projects.getEffectiveOrgPolicy)
   *
   ...
   * accept. An invitation email is not generated if you are granting a role other
   * than owner, or if both the member you are inviting and the project are part
