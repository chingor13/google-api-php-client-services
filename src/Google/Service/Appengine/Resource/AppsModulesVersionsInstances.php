 ...
 *  </code>
 */
class Google_Service_Appengine_Resource_AppsModulesVersionsInstances extends Google_Service_Resource
{
  /**
   ...
   * Example: apps/myapp/modules/default/versions/v1/instances/instance-1.
   ...
   */
  public function debug($appsId, $modulesId, $versionsId, $instancesId, Google_Service_Appengine_DebugInstanceRequest $postBody, $optParams = array())
  {
    $params = array('appsId' => $appsId, 'modulesId' => $modulesId, 'versionsId' => $versionsId, 'instancesId' => $instancesId, 'postBody' => $postBody);
   ...
   * @return Google_Service_Appengine_Operation
   */
  public function delete($appsId, $modulesId, $versionsId, $instancesId, $optParams = array())
  {
    $params = array('appsId' => $appsId, 'modulesId' => $modulesId, 'versionsId' => $versionsId, 'instancesId' => $instancesId);
    $params = array_merge($params, $optParams);
   ...
   */
  public function get($appsId, $modulesId, $versionsId, $instancesId, $optParams = array())
  {
    $params = array('appsId' => $appsId, 'modulesId' => $modulesId, 'versionsId' => $versionsId, 'instancesId' => $instancesId);
    $params = array_merge($params, $optParams);
   ...
   * (instances.listAppsModulesVersionsInstances)
   *
   * @param string $appsId Part of `name`. Name of the resource requested.
   ...
   */
  public function listAppsModulesVersionsInstances($appsId, $modulesId, $versionsId, $optParams = array())
  {
