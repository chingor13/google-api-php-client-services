 ...
 *  </code>
 */
class Google_Service_Appengine_Resource_AppsModulesVersions extends Google_Service_Resource
{
  /**
   ...
   * api/reference/rest/v1beta4/apps.modules.versions#Version.FIELDS.serving_statu
   * s):  For Version resources that use basic scaling, manual scaling, or run in
   * the App Engine flexible environment. instance_class
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta4/app
   * s.modules.versions#Version.FIELDS.instance_class):  For Version resources
   ...
   * /admin-api/reference/rest/v1beta4/apps.modules.versions#Version.FIELDS.automa
   * tic_scaling):  For Version resources that use automatic scaling and run in
   * the App  Engine standard environment. automatic_scaling.max_idle_instances
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta4/app
   * s.modules.versions#Version.FIELDS.automatic_scaling):  For Version resources
   * that use automatic scaling and run in the App  Engine standard environment.
   * (versions.patch)
   *
   * @param string $appsId Part of `name`. Name of the resource to update.
   * Example: apps/myapp/modules/default/versions/1.
   * @param string $modulesId Part of `name`. See documentation of `appsId`.
   * @param string $versionsId Part of `name`. See documentation of `appsId`.
   * @param Google_Service_Appengine_Version $postBody
   * @param array $optParams Optional parameters.
   ...
   * @return Google_Service_Appengine_Operation
   */
  public function patch($appsId, $modulesId, $versionsId, Google_Service_Appengine_Version $postBody, $optParams = array())
  {
    $params = array('appsId' => $appsId, 'modulesId' => $modulesId, 'versionsId' => $versionsId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
