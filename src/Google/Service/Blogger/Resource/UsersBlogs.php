 ...
 *  </code>
 */
class Google_Service_Blogger_Resource_UsersBlogs extends Google_Service_Resource
{
  /**
   * Retrieves a list of blogs, possibly filtered. (blogs.listUsersBlogs)
   *
  ...
  public function listUsersBlogs($userId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Google_Service_Blogger_BlogList");
  }
}
