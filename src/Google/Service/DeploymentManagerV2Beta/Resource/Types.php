 ...
 *  </code>
 */
class Google_Service_DeploymentManagerV2Beta_Resource_Types extends Google_Service_Resource
{
  /**
   ...
   * results.
   * @return Google_Service_DeploymentManagerV2Beta_TypesListResponse
   */
  public function listTypes($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DeploymentManagerV2Beta_TypesListResponse");
  }
}
