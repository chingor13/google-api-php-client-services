 ...
 *  </code>
 */
class Google_Service_DeploymentManagerV2Beta_Resource_Manifests extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_DeploymentManagerV2Beta_Manifest
   */
  public function get($project, $deployment, $manifest, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_DeploymentManagerV2Beta_Manifest");
  }
  /**
   ...
   * results.
   * @return Google_Service_DeploymentManagerV2Beta_ManifestsListResponse
   */
  public function listManifests($project, $deployment, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DeploymentManagerV2Beta_ManifestsListResponse");
  }
}
