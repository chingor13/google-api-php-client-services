 ...
 *  </code>
 */
class Google_Service_DeploymentManagerV2Beta_Resource_Deployments extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_DeploymentManagerV2Beta_DeploymentsCancelPreviewRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_Operation
   */
  public function cancelPreview($project, $deployment, Google_Service_DeploymentManagerV2Beta_DeploymentsCancelPreviewRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancelPreview', array($params), "Google_Service_DeploymentManagerV2Beta_Operation");
  }
  /**
   ...
   * @param string $deployment The name of the deployment for this request.
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_Deployment
   */
  public function get($project, $deployment, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_DeploymentManagerV2Beta_Deployment");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_Policy
   */
  public function getIamPolicy($project, $resource, $optParams = array())
  {
    $params = array('project' => $project, 'resource' => $resource);
    $params = array_merge($params, $optParams);
    return $this->call('getIamPolicy', array($params), "Google_Service_DeploymentManagerV2Beta_Policy");
  }
  /**
   ...
   *
   * @param string $project The project ID for this request.
   * @param Google_Service_DeploymentManagerV2Beta_Deployment $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_DeploymentManagerV2Beta_Operation
   */
  public function insert($project, Google_Service_DeploymentManagerV2Beta_Deployment $postBody, $optParams = array())
  {
   ...
   * results.
   * @return Google_Service_DeploymentManagerV2Beta_DeploymentsListResponse
   */
  public function listDeployments($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DeploymentManagerV2Beta_DeploymentsListResponse");
  }
  /**
   ...
   * @return Google_Service_DeploymentManagerV2Beta_Operation
   */
  public function patch($project, $deployment, Google_Service_DeploymentManagerV2Beta_Deployment $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @param string $project Project ID for this request.
   * @param string $resource Name of the resource for this request.
   * @param Google_Service_DeploymentManagerV2Beta_GlobalSetPolicyRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_Policy
   */
  public function setIamPolicy($project, $resource, Google_Service_DeploymentManagerV2Beta_GlobalSetPolicyRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setIamPolicy', array($params), "Google_Service_DeploymentManagerV2Beta_Policy");
  }
  /**
   ...
   * @param string $project The project ID for this request.
   * @param string $deployment The name of the deployment for this request.
   * @param Google_Service_DeploymentManagerV2Beta_DeploymentsStopRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_Operation
   */
  public function stop($project, $deployment, Google_Service_DeploymentManagerV2Beta_DeploymentsStopRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('stop', array($params), "Google_Service_DeploymentManagerV2Beta_Operation");
  }
  /**
   ...
   * @param string $project Project ID for this request.
   * @param string $resource Name of the resource for this request.
   * @param Google_Service_DeploymentManagerV2Beta_TestPermissionsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_DeploymentManagerV2Beta_TestPermissionsResponse
   */
  public function testIamPermissions($project, $resource, Google_Service_DeploymentManagerV2Beta_TestPermissionsRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('testIamPermissions', array($params), "Google_Service_DeploymentManagerV2Beta_TestPermissionsResponse");
  }
  /**
   * Updates a deployment and all of the resources described by the deployment
   ...
   * @return Google_Service_DeploymentManagerV2Beta_Operation
   */
  public function update($project, $deployment, Google_Service_DeploymentManagerV2Beta_Deployment $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
