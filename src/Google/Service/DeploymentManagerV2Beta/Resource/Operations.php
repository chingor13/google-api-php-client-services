 ...
 *  </code>
 */
class Google_Service_DeploymentManagerV2Beta_Resource_Operations extends Google_Service_Resource
{
  /**
  ...
  public function get($project, $operation, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_DeploymentManagerV2Beta_Operation");
  }
  /**
   ...
   * results.
   * @return Google_Service_DeploymentManagerV2Beta_OperationsListResponse
   */
  public function listOperations($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DeploymentManagerV2Beta_OperationsListResponse");
  }
}
