 ...
 *  </code>
 */
class Google_Service_DeploymentManagerV2Beta_Resource_Resources extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_DeploymentManagerV2Beta_DeploymentmanagerResource
   */
  public function get($project, $deployment, $resource, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_DeploymentManagerV2Beta_DeploymentmanagerResource");
  }
  /**
   ...
   * results.
   * @return Google_Service_DeploymentManagerV2Beta_ResourcesListResponse
   */
  public function listResources($project, $deployment, $optParams = array())
  {
    $params = array('project' => $project, 'deployment' => $deployment);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DeploymentManagerV2Beta_ResourcesListResponse");
  }
}
